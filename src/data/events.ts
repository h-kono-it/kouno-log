...
export const events: Event[] = [
  ...
  { name: '大Funabashi.dev', date: '2026-09-12', role: '登壇', url: 'https://funabashidev.connpass.com/event/398253/', slideUrl: 'https://www.docswell.com/s/hk_it7/K1QEY2-dai_funadev-docs' },
