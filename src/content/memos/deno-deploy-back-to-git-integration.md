...
![プレビューモードで起動しているように見えるログ](./images/deno_deploy_preview_log.png)
...
![cli経由でのdeploy後のcronの状態](./images/run_new_cron.png)

![git integrationに戻したらcronの実行完了状態が戻った](./images/lost_succeeded.png)
